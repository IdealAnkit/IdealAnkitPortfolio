...
const Footer = () => {
  return (
    <footer className="w-full glass-panel bg-opacity-60 border-t border-white/20 dark:border-white/10 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          
          {/* Copyright */}
          <div className="text-gray-600 dark:text-gray-400 text-sm">
            © {new Date().getFullYear()} Ideal.Ankit. All rights reserved.
          </div>

          {/* Social Links */}
          <div className="flex items-center gap-6">
             <a 
               href="https://github.com/IdealAnkit" 
               target="_blank" 
            ...
            <a 
              href="https://www.linkedin.com/in/idealankit/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 transition-colors"
              aria-label="LinkedIn"
            ...
            <a 
              href="https://leetcode.com/u/IdealAnkit/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-gray-500 hover:text-yellow-500 dark:text-gray-400 dark:hover:text-yellow-500 transition-colors"
              aria-label="LeetCode"
            >
              <svg 
             ...
             <a 
               href="https://www.instagram.com/ideal_ankit_/" 
               target="_blank" 
               rel="noopener noreferrer"
